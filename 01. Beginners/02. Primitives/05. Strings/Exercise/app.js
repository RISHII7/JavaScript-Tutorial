...
let favActorFirstName = "Varun ";
let favActorLastName = "Dhawan";

let fullName = favActorFirstName.concat(favActorLastName);
let uppercase = fullName.toUpperCase();
let message = `My favorite actor is ${favActorFirstName.toUpperCase()}and he's appeared in my bollywood movies. `;

message += "He's married now"
